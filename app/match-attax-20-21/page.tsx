...
export default function MatchAttax2021() {
  const [checklists, setChecklists] = useState<CardEntry[]>([]);
  const collection = "MA2021";

  useEffect(() => {
    fetch("/data/ma2021/MA2021.json")
      .then((res) => {
      ...
      <main className="pt-20 pb-8 px-4">
        ...
        <div className="max-w-4xl mx-auto">
          <p className="text-lg text-center mb-8">
            Explore the 2020 installment of Match Attax with cards from the 20/21 Season of Uefa Club Competitions.
          </p>
        ...
        >
          ...
          <br />
          <Table>
            <TableCaption>Match Attax 20/21 Checklist</TableCaption>
            <TableHeader>
              <TableRow>
                    ...
                    {card.image ? (
                      <HoverCard>
                        <HoverCardTrigger asChild>
                          <a
                            href={`/match-attax-20-21/${encodeURIComponent(card.card)}`}
