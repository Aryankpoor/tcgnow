...
export default function MatchAttax2026p() {
  ...
  const collection = "SA2021";

  useEffect(() => {
    fetch("/data/sa2021/SA2021.json")
      .then((res) => {
    ...
    <div>
      ...
      <main className="pt-20 pb-8 px-4">
        ...
        <h1 className="scroll-m-20 text-center text-4xl font-extrabold tracking-tight text-balance mb-8">
          Topps Slam Attax 2021
        </h1>

        <div className="max-w-4xl mx-auto">
          <p className="text-lg text-center mb-8">
            Explore the complete Topps Slam Attax 2021 collection.
          </p>
                    ...
                    {card.image ? (
                      <HoverCard>
                        <HoverCardTrigger asChild>
                          <a
                            href={`/slam-attax-2021/${encodeURIComponent(card.card)}`}
