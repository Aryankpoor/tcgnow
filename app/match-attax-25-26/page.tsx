...
export default function MatchAttax2425e() {
  const [checklists, setChecklists] = useState<CardEntry[]>([]);
  const collection = "MA2526";

  useEffect(() => {
    fetch("/data/ma2526/MA2526.json")
      .then((res) => {
      ...
      <main className="pt-20 pb-8 px-4">
        ...
        <div className="max-w-4xl mx-auto">
          <p className="text-lg text-center mb-8">
            Explore the latest installment in the Match Attax Extra series with Match Attax Extra version of 24/25 Season.
          </p>
        ...
        >
          ...
          <br />
          <Table>
            <TableCaption>Match Attax 25/26 Checklist</TableCaption>
            <TableHeader>
              <TableRow>
                    ...
                    {card.image ? (
                      <HoverCard>
                        <HoverCardTrigger asChild>
                          <a
                            href={`/match-attax-24-25-extra/${encodeURIComponent(card.card)}`}
