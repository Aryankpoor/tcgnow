...
export default function MatchAttax1718() {
  const [checklists, setChecklists] = useState<CardEntry[]>([]);
  const collection = "MA1718";

  useEffect(() => {
    fetch("/data/ma2017/MA1718p.json")
      .then((res) => {
    ...
    <div>
      ...
      <main className="pt-20 pb-8 px-4">
        ...
        <h1 className="scroll-m-20 text-center text-4xl font-extrabold tracking-tight text-balance mb-8">
          Match Attax Premier League 17/18
        </h1>

        <div className="max-w-4xl mx-auto">
          <p className="text-lg text-center mb-8">
            Explore the complete Match Attax 17/18 collection.
          </p>
                    ...
                    {card.image ? (
                      <HoverCard>
                        <HoverCardTrigger asChild>
                          <a
                            href={`/match-attax-2017/${encodeURIComponent(card.card)}`}
