...
export default function MatchAttax2223() {
  ...
  const collection = "MA2223";

  useEffect(() => {
    fetch("/data/ma2223/MA2223.json")
      .then((res) => {
      ...
      <main className="pt-20 pb-8 px-4">
        ...
        <div className="max-w-4xl mx-auto">
          <p className="text-lg text-center mb-8">
            Explore the 2022 installment of Match Attax with cards from the 22/23 Season of Uefa Club Competitions.
          </p>
                    ...
                    {card.image ? (
                      <HoverCard>
                        <HoverCardTrigger asChild>
                          <a
                            href={`/match-attax-22-23/${encodeURIComponent(card.card)}`}
