...
export default function MatchAttax1819() {
  const [checklists, setChecklists] = useState<CardEntry[]>([]);
  const collection = "MA1819";

  useEffect(() => {
    fetch("/data/ma1819/MA1819.json")
      .then((res) => {
      ...
      <main className="pt-20 pb-8 px-4">
        ...
        <div className="max-w-4xl mx-auto">
          <p className="text-lg text-center mb-8">
            Explore the 2018 installment of Match Attax with cards from the 18/19 Season of Uefa Club Competitions.
          </p>
        ...
        >
          ...
          <br />
          <Table>
            <TableCaption>Match Attax 18/19 Checklist</TableCaption>
            <TableHeader>
              <TableRow>
                    ...
                    {card.image ? (
                      <HoverCard>
                        <HoverCardTrigger asChild>
                          <a
                            href={`/match-attax-18-19/${encodeURIComponent(card.card)}`}
